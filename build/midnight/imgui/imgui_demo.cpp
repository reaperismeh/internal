...
//   - Read Getting Started https://github.com/ocornut/wiki/Getting-Started
...
// - Use Tools->Item Picker to debug break in code by clicking any widgets: https://github.com/ocornut/wiki/Debug-Tools
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            // Also read: https://github.com/ocornut/wiki/Error-Handling
            ...
            // Also read: https://github.com/ocornut/wiki/Debug-Tools
...
static void ShowDemoWindowWidgets(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        // - Read https://github.com/ocornut/blob/master/docs/FAQ.md
        // - Read https://github.com/ocornut/wiki/Image-Loading-and-Displaying-Examples
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            // Read about UV coordinates here: https://github.com/ocornut/wiki/Image-Loading-and-Displaying-Examples
            ImGui::PushID(i);
            if (i > 0)
    ...
    // (see others https://github.com/ocornut/wiki/Useful-Extensions)
...
// Also read: https://github.com/ocornut/wiki/Multi-Select
//-----------------------------------------------------------------------------
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("FAQ", "https://github.com/ocornut/blob/master/docs/FAQ.md");
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("Wiki", "https://github.com/ocornut/wiki");
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("Releases", "https://github.com/ocornut/releases");
    ImGui::SameLine();
    ImGui::TextLinkOpenURL("Funding", "https://github.com/ocornut/wiki/Funding");
