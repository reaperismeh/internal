...
inline ImColor main_color = { 3, 252, 252, 255 };
...
// - Read https://github.com/ocornut/wiki/Error-Handling for details on error handling.
...
//#endif
    ...
    IMGUI_API bool          Tabs(const char* label, const char* icon, const ImVec2& size_arg, bool selected, ImGuiButtonFlags flags = 0);
